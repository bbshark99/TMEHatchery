...
contract TMETraitOracle2 is Ownable{
    ...
    function registerSeedForIncubation(uint256 targetBlock, address owner, uint256 startTimestamp, uint256 incubationId) public onlyHatchery {
        uint256 randomN = uint256(keccak256(abi.encodePacked(targetBlock, uint256(owner), startTimestamp, incubationId, seed)));
